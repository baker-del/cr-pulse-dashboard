...
PROJECTS = [
    ...
    },
    {
        ...
        "tagline": "Integration partnerships across AEC, Accounting, Legal, Insurance — expand ClearlyRated's distribution",
        "owner": "Baker",
        "status": "On Track",
        "phase": "Active outreach — 10 targets engaged, 4 prospecting",
        "updates": [
            "Deltek (AEC) — In Progress. First call Apr 21.",
            "Unanet (AEC) — In Progress. Update expected Apr 21.",
            "Karbon (Accounting) — Initiated. Meeting with Sam Ultesch Jun 4.",
            "Clio (Legal) — Initiated. Jack Newton + Shubham Datta outreach Apr 18.",
            "Thomson Reuters (Legal/Accounting) — Initiated. Connection requests sent to Ali, Salimah on LinkedIn.",
            "Intapp (Legal/PS) — Initiated. Sebastian Hartman, Dennis Lee contacted Apr 20.",
            "Wolters Kluwer (Legal) — Initiated. Ricardo Buitron contacted Apr 20.",
            "LexisNexis (Legal) — Initiated. Suzanne, Raja contacted Apr 20.",
            "Applied Systems, Vertafore (Insurance) — Prospecting. Target: Jun 2026.",
            "TaxDome (Accounting), iCIMS (HR/RPO) — Prospecting. Target: Jun 2026.",
        ],
        "due_next_30": [
            {"item": "Deltek — first call", "due": "2026-04-21", "owner": "Baker"},
            {"item": "Unanet — update expected", "due": "2026-04-21", "owner": "Baker"},
            {"item": "Thomson Reuters, Intapp, Wolters Kluwer, LexisNexis — follow-up on LinkedIn outreach", "due": "2026-05-05", "owner": "Baker"},
        ],
        "docs": [
            {"label": "📋 Partnership Tracker", "url": "https://docs.google.com/spreadsheets/d/1IaQTp6HRwixleYs6hz1PDYSBaCNyre-v7N8DDIc5CLs/edit"},
            {"label": "📄 Partnership Strategy", "url": "https://docs.google.com/document/d/1kOP2KPBC7Ul38GyECLHTCBeBAYwCHGI703dCWSzUDBQ/edit"},
            {"label": "📊 Market Signal Report", "url": "https://docs.google.com/spreadsheets/d/1g411aRbC7YFWBQNcv2qwZbg0AA2djDpw/edit"},
            {"label": "📁 Drive Folder", "url": "https://drive.google.com/drive/folders/19l9ZFIq5GpYhWbUCF0zThHbB0QhJ3d92"},
        ],
    },
    {
        "name": "Moonshot",
